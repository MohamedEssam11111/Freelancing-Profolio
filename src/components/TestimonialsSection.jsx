...
const testimonials = [
  {
    name: "Emad Abdalla",
    image: "/assets/emad.png",
    portfolioPreview: "/assets/emad portfolio.png",
    feedback: "“Thank you, Mohamed, for building my portfolio. You captured my work beautifully and made it simple for patients to connect with me. I truly appreciate your professionalism, and I highly recommend you to anyone looking for a reliable developer.”"
  },
  {
    name: "Mohamed Ramadan",
    image: "/assets/ramadan.png",
    portfolioPreview: "/assets/ramadan portfolio.png",
    feedback: "“شكراً ليك يا محمد على بناء البورتفوليو بتاعي. قدرت تعرض مشاريعي ومهاراتي في النيتوركنج بشكل واضح وبطريقة طبيعية تعكس شخصيتي. التجربة معاك كانت ممتازة، وأنصح أي حد محتاج يظهر شغله إنه يتعاون معاك لأنك مطوّر ويب محترف.”"
  }
];
...
const TestimonialsSection = ({ isDark }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute top-0 left-0 w-full h-full pointer-events-none opacity-20 ${isDark ? 'block' : 'hidden'}`}>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 relative z-10">
        ...
        <div className="testimonials-header mb-24 md:mb-32">
          ...
          <p className={`font-body text-xl max-w-2xl leading-relaxed ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
            Real feedback from professionals I've collaborated with on their digital journeys.
          </p>
        </div>
          ...
          {testimonials.map((t, idx) => (
            ...
            >
              ...
              <div className="relative mb-12">
                <span className={`absolute -top-6 -left-4 text-7xl font-serif opacity-10 ${isDark ? 'text-white' : 'text-black'}`}>“</span>
                <p className={`font-body text-lg md:text-xl italic leading-relaxed relative z-10 ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>
                  {t.feedback}
                </p>
              </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h4 className={`text-xl font-heading uppercase tracking-wider ${isDark ? 'text-white' : 'text-black'}`}>
                    {t.name}
                  </h4>
