...
/**
 * BB8Button Component
 * @param {string} size - The size of the button (e.g., "16px", "1.5rem", "10px"). Defaults to "16px".
 * @param {function} onClick - Optional callback function triggered on state change.
 * @param {boolean} defaultActive - Initial state of the toggle.
 */
const BB8Button = ({ size = "16px", onClick, defaultActive = false }) => {
    ...
    <>
      <style>
        {`
          ...
          .bb8-toggle.is-active .bb8-toggle__star:nth-child(1) { top: 0.625em; }
          .bb8-toggle.is-active .bb8-toggle__star:nth-child(2) { top: 1.875em; }
          .bb8-toggle.is-active .bb8-toggle__star:nth-child(3) { top: 1.25em; }
          .bb8-toggle.is-active .bb8-toggle__star:nth-child(4) { top: 3.438em; }
          .bb8-toggle.is-active .bb8-toggle__star:nth-child(5) { top: 3.438em; }
          .bb8-toggle.is-active .bb8-toggle__star:nth-child(6) { top: 0.313em; }
          .bb8-toggle.is-active .bb8-toggle__star:nth-child(7) { top: 1.875em; }
          .bb8-toggle.is-active .bb8-toggle__cloud { right: -100%; }
          .bb8-toggle.is-active .gomrassen { top: 0.938em; }
          .bb8-toggle.is-active .hermes { top: 2.5em; }
          .bb8-toggle.is-active .chenini { top: 2.75em; }
          .bb8-toggle.is-active .bb8-toggle__container { background-position-y: 0; }
          .bb8-toggle.is-active .tatto-1 { top: 100%; }
          .bb8-toggle.is-active .tatto-2 { top: 100%; }
          .bb8-toggle.is-active .bb8 { left: calc(100% - var(--bb8-diameter) - var(--toggle-offset)); }
          .bb8-toggle.is-active .bb8__shadow { 
            left: calc(100% - var(--bb8-diameter) - var(--toggle-offset) + 0.938em);
            transform: skew(70deg);
          }
          .bb8-toggle.is-active .bb8__body { transform: rotate(225deg); }

          .bb8-toggle:hover .bb8__head::before { left: 100%; }
          .bb8-toggle:not(.is-active):hover .bb8__antenna:nth-child(1) { right: 1.5em; }
          .bb8-toggle:hover .bb8__antenna:nth-child(2) { left: 0.938em; }
          .bb8-toggle:hover .bb8__head::after { background-position: 1.375em 0; }

          .bb8-toggle.is-active:hover .bb8__head::before { left: 0; }
          .bb8-toggle.is-active:hover .bb8__antenna:nth-child(2) { left: calc(100% - 0.938em); }
          .bb8-toggle.is-active:hover .bb8__head::after { background-position: -1.375em 0; }

          .bb8-toggle:active .bb8__head-container { transform: rotate(25deg); }
          .bb8-toggle.is-active:active .bb8__head-container { transform: rotate(-25deg); }
      ...
      <button
        className={`bb8-toggle ${isActive ? "is-active" : ""}`}
        onClick={handleToggle}
        aria-label="Toggle BB-8 Scene"
      >
