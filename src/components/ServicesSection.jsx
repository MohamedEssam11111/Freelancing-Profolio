...
import yumifyImg from '../../assets/yumify1.png';
...
const services = [
  {
    ...
    description: "Modern portfolios that showcase your work and help you stand out.",
    image: portfolioImg
  },
  {
    title: "Landing Pages That Convert",
    description: "Focused landing pages built to drive action and maximize results.",
    image: coffeeImg
  },
  {
    title: "Conversion-Focused Websites",
    description: "Websites designed to guide users, increase engagement, and turn visitors into clients.",
    image: yumifyImg
  },
];
...
const ServicesSection = ({ isDark }) => {
  ...
  return (
    <section 
      ...
      style={{
        backgroundColor: isDark ? 'rgba(11, 11, 15, 0.75)' : 'rgba(248, 249, 252, 0.75)',
            ...
            <div className="relative z-[2] h-full flex flex-col justify-end p-6 sm:p-12 md:p-16 lg:p-24 pb-24 sm:pb-32">
              <div className="w-full max-w-[90vw] md:max-w-[700px] lg:max-w-7xl">
                ...
                <div className="relative inline-block mt-2 md:mt-4 mb-4 md:mb-6">
                  ...
                  {/* Fill Layer */}
                  <div 
                    className="secondary-fill absolute top-0 left-0 h-full overflow-hidden whitespace-normal font-body text-[clamp(1rem,4vw,1.25rem)] sm:text-[clamp(1.25rem,4vw,1.5rem)] md:text-[clamp(1.5rem,3vw,1.875rem)] lg:text-3xl font-medium tracking-wide text-dark-primary border-r-2 border-dark-primary w-0 leading-relaxed"
                  >
